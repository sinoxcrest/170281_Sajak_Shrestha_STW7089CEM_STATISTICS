...
X_CSV_DATA=as.matrix(read.csv(file="C:/Users/sinox/Downloads/X_1673241366257.csv",header = F))
colnames(X_CSV_DATA)<-c("X1","X2","X3","X4")

# importing y data
Y_CSV_DATA=as.matrix(read.csv(file="C:/Users/sinox/Downloads/y_1673241374123.csv",header = F))
colnames(Y_CSV_DATA)<-c("Y")


# importing time data
Time_CSV_DATA = as.matrix(read.csv(file="C:/Users/sinox/Downloads/time_1673241270748.csv",header = F))
...
hist(X_CSV_DATA,freq = FALSE,main = "Histogram and Density")
...
lines(density_of_X2,lwd=2,col="green")
...
qqnorm(model1_error, col = "black",main = "QQ plot of model 1")
...
qqnorm(model2_error, col = "black",main = "QQ plot of model 2")
...
###ploting the graph
plot(f_value,s_value, col = c("red", "black"), main = "Joint and Marginal Posterior Distribution")
par(mfrow=c(1,1))
